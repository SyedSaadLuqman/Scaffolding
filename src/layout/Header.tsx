                          ...
                          >
                            ...
                            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                              <div className="menu-item">
                                <a
                                  className="menu-link py-3"
                                  href="../../demo1/dist/pages/faq/classNameic.html"
                                >
                                  <span className="menu-bullet">
                                    <span className="bullet bullet-dot"></span>
                                  </span>
                    ...
                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                      ...
                      <div className="menu-item">
                        ...
                        >
                          ...
                          <span className="menu-title">Changelog v8.0.35</span>
                        </a>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="scroll-y mh-200px mh-lg-350px">
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/src/assets/media/avatars/300-6.jpg"
                                alt=""
                              />
                            </div>
                            {/*end::Symbol*/}
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/src/assets/media/avatars/300-2.jpg"
                                alt=""
                              />
                            </div>
                            {/*end::Symbol*/}
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/src/assets/media/avatars/300-9.jpg"
                                alt=""
                              />
                            </div>
                            {/*end::Symbol*/}
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/src/assets/media/avatars/300-14.jpg"
                                alt=""
                              />
                            </div>
                            {/*end::Symbol*/}
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/src/assets/media/avatars/300-11.jpg"
                                alt=""
                              />
                            </div>
                            {/*end::Symbol*/}
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  ...
                                  src="/src/assets/media/svg/brand-logos/volicity-9.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/src/assets/media/svg/brand-logos/tvit.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/src/assets/media/svg/misc/infography.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/src/assets/media/svg/brand-logos/leaf.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/src/assets/media/svg/brand-logos/tower.svg"
                                  alt=""
                                />
                              </span>
                            </div>
              ...
              <div className="d-flex align-items-center ms-1 ms-lg-3">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("/src/assets/media/misc/pattern-1.jpg")',
                    }}
                  >
                    {/*begin::Title*/}
                      ...
                      <div className="d-flex flex-column px-9">
                        ...
                        <div className="text-center px-4">
                          <img
                            ...
                            alt="image"
                            src="/src/assets/media/illustrations/sketchy-1/1.png"
                          />
                        </div>
                        {/*end::Illustration*/}
                      </div>
                  ...
                  <div className="menu-item px-3">
                    <div className="menu-content d-flex align-items-center px-3">
                      ...
                      <div className="symbol symbol-50px me-5">
                        <img
                          alt="Logo"
                          src="/src/assets/media/avatars/300-1.jpg"
                        />
                      </div>
                      {/*end::Avatar*/}
                      {/*begin::Username*/}
                      ...
                      <span className="menu-title position-relative">
                        ...
                        <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                          ...
                          <img
                            ...
                            src="/src/assets/media/flags/united-states.svg"
                            alt=""
                          />
                        </span>
                      </span>
                      ...
                      <div className="menu-item px-3">
                        ...
                        >
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/src/assets/media/flags/spain.svg"
                              alt=""
                            />
                          </span>
                          Spanish
                      ...
                      <div className="menu-item px-3">
                        ...
                        >
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/src/assets/media/flags/germany.svg"
                              alt=""
                            />
                          </span>
                          German
                      ...
                      <div className="menu-item px-3">
                        ...
                        >
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/src/assets/media/flags/japan.svg"
                              alt=""
                            />
                          </span>
                          Japanese
                      ...
                      <div className="menu-item px-3">
                        ...
                        >
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/src/assets/media/flags/france.svg"
                              alt=""
                            />
                          </span>
                          French
