        ...
        >
          ...
          >
            ...
            <h1 className="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
              Dashboard - From Content Component in Layout
              {/*begin::Separator*/}
                        ...
                        <div className="mb-10">
                          ...
                          <div>
                            <select
                              ...
                              data-kt-select2="true"
                              data-placeholder="Select option"
                              data-dropdown-parent="#kt_menu_61de0c0cb063b"
                              data-allow-clear="true"
                            >
                              <option></option>
                              <option value="1">Approved</option>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="symbol symbol-45px me-5">
                                <img
                                  src="/src/assets/media/avatars/300-5.jpg"
                                  alt=""
                                />
                              </div>
                              <div className="d-flex justify-content-start flex-column">
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="symbol symbol-45px me-5">
                                <img
                                  src="/src/assets/media/avatars/300-20.jpg"
                                  alt=""
                                />
                              </div>
                              <div className="d-flex justify-content-start flex-column">
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="symbol symbol-45px me-5">
                                <img
                                  src="/src/assets/media/avatars/300-23.jpg"
                                  alt=""
                                />
                              </div>
                              <div className="d-flex justify-content-start flex-column">
                ...
                <div className="card-body pt-5">
                  ...
                  <div className="d-flex align-items-sm-center mb-7">
                    ...
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label">
                        <img
                          src="/src/assets/media/svg/brand-logos/plurk.svg"
                  ...
                  <div className="d-flex align-items-sm-center mb-7">
                    ...
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label">
                        <img
                          src="/src/assets/media/svg/brand-logos/telegram.svg"
                          className="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                  ...
                  <div className="d-flex align-items-sm-center mb-7">
                    ...
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label">
                        <img
                          src="/src/assets/media/svg/brand-logos/vimeo.svg"
                          className="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                  ...
                  <div className="d-flex align-items-sm-center mb-7">
                    ...
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label">
                        <img
                          src="/src/assets/media/svg/brand-logos/bebo.svg"
                          className="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                  ...
                  <div className="d-flex align-items-sm-center mb-7">
                    ...
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label">
                        <img
                          src="/src/assets/media/svg/brand-logos/kickstarter.svg"
                          className="h-50 align-self-center"
                          alt=""
                        />
                      </span>
                    ...
                    <div className="d-flex flex-stack mb-5">
                      ...
                      <div className="d-flex align-items-center me-2">
                        ...
                        <div className="symbol symbol-50px me-3">
                          <div className="symbol-label bg-light">
                            <img
                              src="/src/assets/media/svg/brand-logos/figma-1.svg"
                              className="h-50"
                              alt=""
                            />
                          </div>
